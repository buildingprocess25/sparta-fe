  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-8">
        <section className="w-full max-w-[900px] overflow-hidden rounded-lg border border-slate-200 bg-white shadow-[0_16px_46px_rgba(15,23,42,0.10)]">
          <div className="grid md:grid-cols-[0.82fr_1.18fr]">
            <aside className="relative border-b border-slate-200 bg-white p-6 md:border-b-0 md:border-r">
              <div className="absolute inset-x-0 top-0 h-1 bg-red-600" />
              <div className="flex items-center gap-3">
                <div className="flex h-11 w-11 items-center justify-center rounded-md bg-red-600 text-white shadow-sm">
                  <Building2 className="h-5 w-5" />
                </div>
                <div>
                  <p className="text-[10px] font-black uppercase tracking-[0.18em] text-slate-400">SPARTA Building</p>
                  <p className="text-sm font-black text-slate-950">Kontrol Akses</p>
                </div>
              </div>

              <div className="mt-10">
                <div className="inline-flex items-center gap-2 rounded-md border border-red-100 bg-red-50 px-3 py-1.5 text-xs font-bold text-red-700">
                  <ShieldAlert className="h-3.5 w-3.5" />
                  Di luar jam operasional
                </div>
                <h1 className="mt-5 text-3xl font-black leading-tight text-slate-950">Akses belum dibuka</h1>
                <p className="mt-3 max-w-sm text-sm leading-6 text-slate-600">
                  Akun Anda tetap aktif. Silakan masuk kembali saat jadwal operasional dibuka.
                </p>
              </div>

              <div className="mt-10 rounded-md border border-slate-200 bg-slate-50 p-4">
                <p className="text-[10px] font-black uppercase tracking-[0.16em] text-slate-400">Sesi pengguna</p>
                <p className="mt-2 text-sm font-black text-slate-950">{user.namaLengkap}</p>
                <p className="mt-1 text-xs font-semibold text-slate-500">{user.cabang || 'Cabang tidak tersedia'}</p>
              </div>
            </aside>
            ...
            <main className="p-6 md:p-8">
              ...
              <div className="mt-6 grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-md border border-slate-200 bg-white p-4 shadow-sm">
                  ...
                  <p className="mt-3 font-mono text-3xl font-black text-red-600">{closeTime || '--:--'}</p>
                </div>
              </div>
              ...
              <div className="mt-6 rounded-md border border-red-100 bg-red-50 px-4 py-3 text-sm font-medium leading-6 text-red-800">
              ...
              <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  onClick={onLogout}
                  className="inline-flex h-11 items-center justify-center gap-2 rounded-md bg-red-600 px-5 text-sm font-black text-white shadow-sm transition hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-200"
                >
