          ...
          <div className="w-full max-w-[492px] overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-2xl shadow-slate-950/25">
            ...
            <div className="space-y-5 px-6 py-8">
              ...
              <Field label="Email SAT *">
                <input type="email" value={form.email_sat} onChange={(event) => setForm({ ...form, email_sat: event.target.value })} disabled={editingId !== null} placeholder="contoh@alfamart.co.id" className="dc-input disabled:opacity-60 disabled:cursor-not-allowed" />
              </Field>
